...
(function () {
  ...
  wp.data.subscribe(function () {
    const results = wp.data.select("core/block-editor").getBlocks().filter(function (block) {
      return block.name == "mdppplugin/materialy-do-pobrania-podstrona" && block.attributes.elements[0] == "";
    });
...
wp.blocks.registerBlockType('mdppplugin/materialy-do-pobrania-podstrona', {
  title: "Materiały do pobrania - podstrona",
  icon: "admin-page",
  category: "common",
  attributes: {
    title: {
...
function EditComponent(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "download-page-edit-block"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    className: "download-page-headline"
  }, "Generator zawarto\u015Bci podstrony z materia\u0142ami do pobrania."), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Flex, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.FlexBlock, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
      ...
      value: el,
      onChange: newValue => {
        const newElements = props.attributes.elements.concat([]);
    ...
    onClick: () => {
      props.setAttributes({
        elements: props.attributes.elements.concat([undefined]),
        links: props.attributes.links.concat([undefined])
      });
    }
  }, "Dodaj element"));
}
